...
def write_grid_netCDF_richards_lysimeter(eta, eta_dual, z, z_dual, space_delta, control_volume, control_volume_index, psi_0, T_0, root_0, equation_state_ID, parameter_ID, KMAX, theta_s, theta_r, theta_wp, theta_fc, par_1, par_2, par_3, par_4, par_5, alpha_ss, beta_ss, ks, output_file_name, output_title, output_institution, output_summary, output_date, grid_input_file_name, parameter_input_file_name):
    '''
    ...
    :param root_0: root distribution initial condition.
    :type ic: array.
    ...
    data_root_0 = ncfile.createVariable('root0','f8',('z'))
    data_root_0.units = '-'
    data_root_0.long_name = 'Root distribution initial condition'
